...
public class Truck implements Automobile {
	...
	public Truck(String stockId, int modelYear, String model, int numberOfSeats, float capacityILitres,
			float zeroToSixtyInSeconds, int towingCapacityInPounds, int fuelEconomyInMpg, boolean isFourWheelDrive,
			int marketValueinUsd) {
		super();
	...
	public String toString() {
		return "Truck [stockId=" + stockId + ", modelYear=" + modelYear + ", model=" + model + "]";
	}
